package thisKeyword;
//If I want to pass the current object of thisKeyword.UsingThis to another method that might be using its properties. We can directly do it by passing this methodCall(this).
